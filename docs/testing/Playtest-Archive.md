...
<a id="playtest-27-28"></a>

# ══ Playtests 27 & 28 ══

**Closed 2026-08-27**, at the start of the 0.93.0 pass. Every row below is BUILT — this is the "My
Finds" section of `Open-Checklist.md` as he wrote it across two passes (27 on 2026-08-23, 28 on
2026-08-23), moved here verbatim once the last of it shipped. It was the most productive stretch of
free-form finding so far: **twelve finds in playtest 28 alone**, three of which turned out to be rules
that had been written down and reached nothing.

What it cost, for the record: 0.79.0 through 0.82.0, plus the 0.81.2 reversal of his vamp-bolt
question — where he was right and the fizzle had been reading the caster's level instead of the
rung's since the feature was written.

Two rows did NOT close and are not archived with the rest; they were routed out of the checklist:
* **`BL-90`** — the per-skill debuff success multiplier he asked about. It shipped in 0.83.0, so the row closed after all.
* **the fizzle floor** — *"shouldnt hit at all on the floor"*, still unbuilt → `BL-94` in `docs/Backlog.md`.
...
<a id="playtest-26-finds"></a>

# ══ Playtest 26 — his six free-form finds of 2026-08-22 ══

**Closed 2026-08-27.** Five were built in 0.78.0 and the sixth was routed to `BL-86`. This was §91 of
the Open Checklist.
...
<a id="playtest-25-routing"></a>

# ══ Playtest 25's routing — all of it built ══

**Closed 2026-08-27.** This was §89 of the Open Checklist: where each of his playtest-25 rulings
landed. Every line of it is now built, so it is a record rather than a queue.
