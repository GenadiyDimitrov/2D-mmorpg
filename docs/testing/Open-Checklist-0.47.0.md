# OPEN CHECKLIST — everything still untested as of 0.47.0 (2026-08-05)
...
**Before you start:** install the **0.47.0** APK. Protocol is **12**, unchanged since 0.46.0.
...
file. Coming from 0.46.0, keep your save.

**This is a BIG unplayed batch** — four builds' worth. 0.46.0 and everything since has never been
played at all. Sections 46 and 47 are the new work; everything under "CARRIED FORWARD" is what was
...
## 47. THE FRICTION TIER + REVIEW FIXES (0.47.0 — newest, unplayed)
...
- **E3, the rest of the buff economy** — two rarities, one max-rung scroll per buff, and the
  **Apothecary 250k selection box of 10**. (The "no buff-scroll drops" and "potions sell 0" halves ARE
  built — 46w.)
