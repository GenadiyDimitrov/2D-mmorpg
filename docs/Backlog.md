...
| `BL-287` | ✅ | **PRICES + ESSENCE, IG-SHAPED** — sell 50%, Common 0.05, T1 ×2.2 / T20 ×0.65 / T40-52 ×0.5, break = 40% at essence sell 1500…25000, per-slot Common drops, elite ×2, no healing potions above 40; ruled, build 0.201.0 | items |
