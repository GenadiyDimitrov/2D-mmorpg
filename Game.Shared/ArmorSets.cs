...
public static class ArmorSetCatalog
{
    ...
    // (`QualityVariants` — the derived EPIC and LEGENDARY copies of every set at 70% / 85%, each with its
    //  own quality-suffixed set id — was DELETED with `BL-272` (2026-09-23). Equipment is Common + Mythic
    //  now, and a Common carries no set at all, so the authored set IS the only set.)
